...
print()
print("Welcome to DHS! Please answer the following questions truthfully and we'll suggest a course for you!")
...
if tech_final > outdoor_final and tech_final > music_final:
  print("You might be suitable for an engineering course!")
elif outdoor_final > music_final:
  print("You might be stuiable for a sports science course!")
else:
  print("You might be suitable for music studies!")
